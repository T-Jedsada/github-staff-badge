...
(function() {
    'use strict';
    if ((document.querySelector('.vcard-details') && !!document.querySelector('.p-org')) === false) {
        document.querySelector('.vcard-details').innerHTML = `<li class="vcard-detail pt-1 css-truncate css-truncate-target hide-sm hide-md">
...
<span class="label bg-blue text-uppercase">Staff</span>
        ...
        console.log('%c [GitHub Staff Badge] Badge added', 'background: rgb(63, 81, 181); color: white');
    }
})();
